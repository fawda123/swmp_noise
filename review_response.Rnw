...
{\it We agree!  We've added a link in the supplementary information that provides instructions and examples for installing an R package to implement weighted regression: \href{https://github.com/fawda123/WtRegDO}{https://github.com/fawda123/WtRegDO}}
