...
`Respiration rates were assumed constant during day and night such that total daily rates were calculated as hourly respiration multiplied by 24. Respiration was subtracted from daily net production estimates to yield gross production.'
}
