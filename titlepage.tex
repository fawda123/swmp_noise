\begin{singlespace}
\title{{\bf {\Large Filtering time series of dissolved oxygen for improved estimates of estuary metabolism}}}
\author{
...
\date{}
\maketitle
\vfill{\centerline{\textit {\normalsize Running head: Filtering \acs*{DO} Time Series for Estuary Metabolism}}}
\end{singlespace}
\clearpage